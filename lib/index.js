...
function MasonryComponent(React) {
    return React.createClass({
        ...
        render: function() {
            ...
            return React.createElement ? React.createElement(this.props.elementType, props, this.props.children) : React.DOM[this.props.elementType](props, this.props.children);
        }
    })
}
